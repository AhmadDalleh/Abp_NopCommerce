...
namespace NopCommerceV1.Migrations
{
    ...
    [Migration("20250719143128_add_frist_and_last_name_for_customer")]
    partial class add_frist_and_last_name_for_customer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerCustomerRole", b =>
                {
                    b.Property<Guid>("CustomerRolesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CustomersId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CustomerRolesId", "CustomersId");
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.CustomerPassword", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CustomerPasswords", (string)null);
                });

            modelBuilder.Entity("NopCommerceV1.Customers.CustomerRole", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.NewsLetterSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.RewardPointsHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NopCommerceV1.GenericAttributes.GenericAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EntityId", "KeyGroup", "key");
            ...
            modelBuilder.Entity("AddressCustomer", b =>
                {
                    b.HasOne("NopCommerceV1.Customers.Address", null)
                        .WithMany()
                        .HasForeignKey("AddressesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NopCommerceV1.Customers.Customer", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CustomerCustomerRole", b =>
                {
                    b.HasOne("NopCommerceV1.Customers.CustomerRole", null)
                        .WithMany()
                        .HasForeignKey("CustomerRolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.Customer", b =>
                {
                    b.HasOne("NopCommerceV1.Customers.Address", "BillingAddress")
                        .WithMany()
                        .HasForeignKey("BillingAddressId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("NopCommerceV1.Customers.Address", "ShippingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("NopCommerceV1.Customers.CustomerPassword", b =>
                {
                    b.HasOne("NopCommerceV1.Customers.Customer", "Customer")
